      ...
      input: [
        {
          role: 'system',
          content:
            "Tu es un journaliste du journal Le Monde chargé de rédiger un article quotidien à partir de retranscriptions audio. Ton style est neutre, analytique et précis, sans exagération émotionnelle, avec des phrases claires et une syntaxe élégante. Tu rédiges exclusivement en français.",
        },
        {
          role: 'user',
          content: `Date: ${formattedDate}\n\nRetranscriptions du jour:\n${condensedTranscripts}\n\nConsignes:\n- Rédige l'article dans le style rédactionnel du journal Le Monde.\n- Adopte un ton journalistique neutre, analytique et rigoureux, sans tournures orales ni adresse directe au lecteur.\n- Structure l'article avec un titre informatif, un chapeau synthétique (3 à 4 lignes), des sous-titres pertinents et des paragraphes cohérents.\n- Ouvre par une introduction factuelle qui contextualise le sujet sans lyrisme.\n- Développe de manière équilibrée les points de vue disponibles en restant fidèle aux retranscriptions, sans citations inventées ni spéculations non sourcées.\n- Conclus de façon sobre en ouvrant sur les perspectives ou les enjeux plus larges.\n- Longueur totale attendue : entre 900 et 1 200 mots.\n- Propose un prompt d'illustration pour une image générée par IA qui capture l'atmosphère générale du jour.\n- Fournis un résumé percutant (2 phrases maximum) et une description SEO (160 caractères maximum).\n\nRéponds strictement en JSON au format suivant : {"title": string, "excerpt": string, "content_markdown": string, "cover_image_prompt": string, "tags": string[], "seo_description": string}`,
        },
      ],
      text: {
        format: {
